...
//10ms
 #define	BLE_START_TIME		(HFCLK_1MS*1)
...
void BLE_Get_Pdu(u8 *ptr, u8 *len);
void BLE_Do_Cal();  //calibration
void Carrier(void);
void XOClockOutput(void);
void BLE_TRX(unsigned short value);
void FT_TxFtest_Prom_start(int flag);
void FT_TxFtest_Prom_start1();
void FT_TxFtest_Prom_all(u8 BLE_Test_Ruslt,int flag);
// add by yzq
